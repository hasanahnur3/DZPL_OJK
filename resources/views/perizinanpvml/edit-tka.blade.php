            ...
            <form action="{{ route('tka.update', $tka->id) }}" method="POST"
                ...
                <div style="display: flex; flex-direction: column; gap: 5px;">
                    ...
                    <select name="jenis_output" id="jenis_output" required
                        style="padding: 0.75rem; border: 1px solid #ccc; border-radius: 10px;">
                        <option value="pencatatan" {{ $tka->jenis_output == 'pencatatan' ? 'selected' : '' }}>Pencatatan
                        </option>
                    ...
                    <label for="no_surat_pencatatan" style="font-weight: bold; color: #555;">Nomor Surat Pencatatan /
                        Penolakan</label>
                    <input type="text" name="no_surat_pencatatan" id="no_surat_pencatatan"
                        value="{{ $tka->no_surat_pencatatan }}" required
                        style="padding: 0.75rem; border: 1px solid #ccc; border-radius: 10px;">

                    <label for="tanggal_surat_pencatatan" style="font-weight: bold; color: #555;">Tanggal Surat Pencatatan /
                        Penolakan</label>
