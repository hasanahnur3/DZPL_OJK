        ...
        <div
            ...
            <form action="{{ route('riksus.update', $riksus->id) }}" method="POST"
                ...
                <div style="display: flex; flex-direction: column; gap: 5px;">
                    ...
                    <select id="jenis_industri" name="jenis_industri" required style="height:45px; gap:10px;">
                    ...
                    <select id="nama_perusahaan" name="nama_perusahaan" required style="height:45px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 5px;">
                    ...
                    <label for="no_nd_penyampaian_lhpk_ke_pengawas_dpjk" style="font-weight: bold; color: #555;">Nomor ND
                        Penyampaian LHPK ke DPJK</label>
                    ...
                    <label for="tanggal_nd_penyampaian_lhpk_ke_pengawas_dpjk"
                        style="font-weight: bold; color: #555;">Tanggal ND Penyampaian LHPK ke DPJK</label>
                    ...
                    <label for="tanggal_persetujuan_kadep" style="font-weight: bold; color: #555;">Tanggal Persetujuan
                        Kadep</label>
