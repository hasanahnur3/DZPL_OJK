        ...
        <h3 style="text-align:center;">Edit Data LJK</h3>
            <form action="{{ route('daftarljk.update', $ljk->id) }}" method="POST"
                ...
                <div class="form-group">
                    <input type="text" name="jenis_industri" value="{{ $ljk->jenis_industri }}" placeholder="Jenis Industri"
                        class="form-control" required>
                </div>
                <div class="form-group">
                    <input type="text" name="nama_perusahaan" value="{{ $ljk->nama_perusahaan }}"
                        placeholder="Nama Perusahaan" class="form-control" required><br>
                </div>

                <button type="submit" class="btn btn-primary"
                    style="background-color: #A91111; color: white; border: none; border-radius: 10px; cursor: pointer; height:40px; margin-left:40px;">Simpan
                    Perubahan</button>
