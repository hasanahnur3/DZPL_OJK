    ...
    <form action="{{ route('pkk-agenda.update', $agenda->id) }}" method="POST">
     ...
     <h3 style="text-align:center;">Edit Agenda PKK </h3>
        ...
        <div class="form-group">
            ...
            <input type="text" name="peserta" id="peserta" value="{{ old('peserta', $agenda->peserta) }}" required
                class="form-control">
        </div>

        <div class="form-group">
            <label for="jabatan">Jabatan</label>
            <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $agenda->jabatan) }}" required
                class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="penguji" id="penguji" value="{{ old('penguji', $agenda->penguji) }}" required
                class="form-control">
        </div>

        <div class="form-group">
            <label for="penguji1">Penguji 1</label>
            <input type="text" name="penguji1" id="penguji1" value="{{ old('penguji1', $agenda->penguji1) }}" required
                class="form-control">
        </div>

        <div class="form-group">
            <label for="penguji2">Penguji 2</label>
            <input type="text" name="penguji2" id="penguji2" value="{{ old('penguji2', $agenda->penguji2) }}" required
                class="form-control">
        </div>
        ...
        <button type="submit" class="btn btn-primary" style="background-color: #A91111; color: white; border: none; border-radius: 10px; cursor: pointer;">Update</button>
    </form>
</div>
