...
@section('content')
    ...
    <div class="form-container" style="overflow-x: auto;">
        ...
        <table id="agendaLainnyaTable" class="table"
            ...
            <thead style="background-color: #f8f9fa; border-bottom: 2px solid #dee2e6;">
                <tr>
                    ...
                    <th style="padding: 0.75rem; border: 1px solid #dee2e6; text-align: center; width:20%;">Hari/Tanggal
                    </th>
                    ...
                    <tr>
                        ...
                        <td style="padding: 0.75rem; border: 1px solid #dee2e6; text-align: center;">
                            @if (!in_array(Session::get('role'), ['direktur', 'deputi', 'kabag']))
                                <a href="{{ route('agenda-lainnya.edit', $item->id) }}"
        ...
        <div class="button-container">
            @if (!in_array(Session::get('role'), ['direktur', 'deputi', 'kabag']))
                <a href="{{ route('agenda-lainnya.create') }}" class="btn btn-success" style="color:white;">Add Data</a>
            @endif
        </div>
    </div>
