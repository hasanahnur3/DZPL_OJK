        ...
        <div class="form-container">
            ...
            <form action="{{ route('agenda-lainnya.update', $agendaLainya->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="topik" class="form-control" value="{{ $agendaLainya->topik }}" required>
                </div>
                <div class="form-group">
                    <label for="hasil">Hasil</label>
                    <textarea name="hasil" class="form-control" required>{{ $agendaLainya->hasil }}</textarea>
                </div>
