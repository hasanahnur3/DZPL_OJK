        ...
        <div class="form-container">
            ...
            <form action="{{ route('sosialisasi-riksus.update', $agenda->id) }}" method="POST" style="width:100%;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="judul_sosialisasi" class="form-control"
                        value="{{ old('judul_sosialisasi', $agenda->judul_sosialisasi) }}" required>
                </div>
                <div class="form-group">
                    <label for="hari_tanggal">Hari/Tanggal</label>
                    <input type="date" name="hari_tanggal" class="form-control"
                        value="{{ old('hari_tanggal', $agenda->hari_tanggal) }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan_peserta" class="form-control"
                        required>{{ old('keterangan_peserta', $agenda->keterangan_peserta) }}</textarea>
                </div>
                <div class="form-group">
                    <label for="kesimpulan">Kesimpulan</label>
                    <textarea name="kesimpulan" class="form-control"
                        required>{{ old('kesimpulan', $agenda->kesimpulan) }}</textarea>
                </div>

                <button type="submit" class="btn btn-success"
                    style="background-color: #A91111; color: white; border: none; border-radius: 10px; cursor: pointer; width: 100%; margin-left:5px;">Update
                    Agenda</button>
            </form>
